 ...
 * operations handled by {@see DenormalizerWriterInterface} and the code generation
 * handled by {@see DenormalizerGeneratorInterface}.
 */
interface DenormalizerPathResolverInterface
{
    /**
     * Return the fully-qualified class name of the denormalizer that would be (or was)
     ...
     * the result would be `BuildableSerializerBundle\Generated\N12345678_UserDenormalizer`.
     *
     * @template T of object
     *
     * @param ClassMetadata<T> $metadata
     *
     * @return string Fully-qualified class name of the generated (or to-be-generated) denormalizer.
     */
    public function resolveDenormalizerFqcn(ClassMetadata $metadata): string;

    /**
     * Return the absolute filesystem path where the denormalizer source file for the
     * given metadata would be (or was) written, without performing any file I/O.
     *
     * This is the counterpart of {@see resolveDenormalizerFqcn()} on the filesystem side.
